...
namespace Casbin.UnitTests.SyncedModelTests
{
    ...
    public class SyncedRbacApiTest
    {
        private readonly TestModelFixture _testModelFixture;

        public SyncedRbacApiTest(TestModelFixture testModelFixture)
        {
        ...
        {
            var e = SyncedEnforcer.Create(_testModelFixture.GetNewRbacTestModel());
            e.BuildRoleLinks();
        ...
        {
            var e = SyncedEnforcer.Create(_testModelFixture.GetNewRbacWithDomainsTestModel());
            e.BuildRoleLinks();
        ...
        {
            var e = SyncedEnforcer.Create(_testModelFixture.GetBasicWithoutResourceTestModel());
            e.BuildRoleLinks();
        ...
        {
            var e = SyncedEnforcer.Create(TestModelFixture.GetNewTestModel(
