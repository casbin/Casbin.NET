...
public class WatcherMessageTest
{
    ...
    public void TestUpdatePolicy()
    {
        ...
        MessageEquals(sampleWatcher.WatcherMessage,
            WatcherMessage.CreateUpdatePolicyMessage("p", "p",
                Policy.ValuesFrom(new[] {"alice", "data1", "read"}), Policy.ValuesFrom(new []{"alice", "book2", "write"})));
    }
    ...
    public void TestRemovePolicies()
    {
        ...
        rules = new[]
        {
            new[] {"data2_admin", "data2", "read"}, new[] {"alice", "book3", "read"}
        };
        enforcer.RemovePolicies(rules);
        MessageEquals(sampleWatcher.WatcherMessage,
    ...
    public void TestUpdatePolicies()
    {
        ...
        MessageEquals(sampleWatcher.WatcherMessage,
            WatcherMessage.CreateUpdatePoliciesMessage("p", "p", Policy.ValuesListFrom(oldRules), Policy.ValuesListFrom(newRules)));
    }
    ...
    public async Task TestUpdatePolicyAsync()
    {
        ...
        MessageEquals(sampleWatcher.AsyncWatcherMessage,
            WatcherMessage.CreateUpdatePolicyMessage("p", "p", Policy.ValuesFrom(new []{"alice", "data1", "read"}), Policy.ValuesFrom(new []{"alice", "book2", "write"})));
    }
    ...
    public async Task TestUpdatePoliciesAsync()
    {
        ...
        await enforcer.UpdatePoliciesAsync(new[]
        {
            new[] {"data2_admin", "data2", "read"}, new[] {"frank", "book4", "read"}
        }, new[]
        {
