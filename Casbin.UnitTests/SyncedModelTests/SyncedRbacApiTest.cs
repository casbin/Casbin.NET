...
public class SyncedRbacApiTest
{
    ...
    public SyncedRbacApiTest(TestModelFixture testModelFixture) => _testModelFixture = testModelFixture;
    ...
    {
        IEnforcer e = SyncedEnforcer.Create(_testModelFixture.GetNewRbacWithDomainsTestModel());
        e.BuildRoleLinks();
    ...
    {
        IEnforcer e = SyncedEnforcer.Create(_testModelFixture.GetBasicWithoutResourceTestModel());
        e.BuildRoleLinks();
    ...
    {
        IEnforcer e = SyncedEnforcer.Create(TestModelFixture.GetNewTestModel(
