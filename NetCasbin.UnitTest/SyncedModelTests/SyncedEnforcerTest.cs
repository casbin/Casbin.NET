...
namespace Casbin.UnitTests.SyncedModelTests
{
    ...
    public class SyncedEnforcerTest
    {
        ...
        {
            var e = SyncedEnforcer.Create("examples/rbac_model.conf", "examples/rbac_policy.csv");
        ...
        {
            var e = SyncedEnforcer.Create("examples/basic_model.conf", "examples/basic_policy.csv");
        ...
        {
            var e = SyncedEnforcer.Create("examples/rbac_model.conf");
        ...
        {
            var e = SyncedEnforcer.Create("examples/basic_model.conf", "examples/basic_policy.csv");
            var e2 = SyncedEnforcer.Create("examples/basic_with_root_model.conf", "examples/basic_policy.csv");
        ...
        {
            var e = SyncedEnforcer.Create("examples/basic_model.conf", "examples/basic_policy.csv");
            var e2 = SyncedEnforcer.Create("examples/basic_model.conf", "examples/basic_inverse_policy.csv");
        ...
        {
            var e = SyncedEnforcer.Create("examples/basic_model.conf");
        ...
        {
            var e = SyncedEnforcer.Create(_testModelFixture.GetBasicTestModel());
