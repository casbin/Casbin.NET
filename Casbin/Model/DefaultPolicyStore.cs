...
namespace Casbin.Model
{
    public partial class DefaultPolicyStore : IPolicyStore
    {
        ...
        public bool AddNode(string section, string type, PolicyAssertion policyAssertion)
        {
            ...
            var node = new Node(policyAssertion);
            nodes[type] = node;
            return true;
        }
            ...
            IPolicyValues fieldValues)
        {
            ...
            var node = GetNode(section, policyType);
        ...
        {
            foreach (var nodes in _nodesMap)
            {
        ...
        private IDictionary<string, Node> GetNodes(string section)
        {
            return _nodesMap[section];
        }

        private Node GetNode(string section, string type)
        {
            return _nodesMap[section][type];
        }
    }
}
