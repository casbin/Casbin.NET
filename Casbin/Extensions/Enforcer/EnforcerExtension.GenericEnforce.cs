...
public static partial class EnforcerExtension
{
    ...
    {
        var request = Request.Create(value);
    ...
    {
        var request = Request.Create(value1);
    ...
    {
        var request = Request.Create(value1, value2);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
    ...
    {
        var request = Request.Create(value1, value2, value3);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
    ...
    {
        var request = Request.Create(value1, value2, value3, value4);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
    ...
    public static bool Enforce<T1, T2, T3, T4, T5>(this IEnforcer enforcer, T1 value1, T2 value2, T3 value3, T4 value4,
        T5 value5)
    {
        var request = Request.Create(value1, value2, value3, value4, value5);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
    ...
    {
        var request = Request.Create(value1, value2, value3, value4, value5, value6);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
    ...
    {
        var request = Request.Create(value1, value2, value3, value4, value5, value6, value7);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
    ...
    {
        var request = Request.Create(value1, value2, value3, value4, value5, value6, value7, value8);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
    ...
    {
        var request = Request.Create(value1, value2, value3, value4, value5, value6, value7, value8, value9);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
    ...
    {
        var request = Request.Create(value1, value2, value3, value4, value5, value6, value7, value8, value9, value10);
        return enforcer.Enforce(enforcer.CreateContext(), request);
    }
