    ...
    public class EnforcerWithCacheBenchmark
    {
        ...
        private void GlobalSetupForRbacModelWithScale(int groupCount, int userCount)
        {
            ...
            for (int i = 0; i < groupCount; i++)
            {
                ...
                //It's highly unusual for a user to be able to do only a single action,
                //and in a real world scenarios, there are other actions such as
                //"create", "admin", "alter", "revoke", "copy", "download",
                //"metadata-reader" and others
            ...
            for (int i = 0; i < userCount; i++)
            {
                ...
                //avg is 25 char long, lets take this avg case cenario
        ...
        {
            _ = NowEnforcer.Enforce("user" + (DateTime.Now.Millisecond).ToString().PadLeft(21, '0'), "data" + (DateTime.Now.Second).ToString().PadLeft(16, '0'), "read");
        }
