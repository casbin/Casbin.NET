...
namespace Casbin.Benchmark
{
    ...
    public class DefaultRoleManagerBenchmark
    {
        ...
        [GlobalSetup(Targets = new[] {
            nameof(BuildRoleLinksWithPatternLarge),
            nameof(HasLinkWithPatternLarge)
        })]
        public void GlobalSetupForRbacModelWithMatchingFunc()
        {
            ...
            NowEnforcer.AddNamedMatchingFunc("g", Util.BuiltInFunctions.KeyMatch4);
        }

        [GlobalSetup(Targets = new[] {
            nameof(BuildRoleLinksWithDomainPatternLarge),
            nameof(HasLinkWithDomainPatternLarge)
        })]
        public void GlobalSetupForRbacModelWithDomainMatchingFunc()
        {
            GlobalSetupFromFile("rbac_with_pattern_large_scale_model.conf", "rbac_with_pattern_large_scale_policy.csv");
            NowEnforcer.AddNamedDomainMatchingFunc("g", Util.BuiltInFunctions.KeyMatch4);
        }

        [GlobalSetup(Targets = new[] {
            nameof(BuildRoleLinksWithPatternAndDomainPatternLarge),
            nameof(HasLinkWithPatternAndDomainPatternLarge)
        })]
        ...
        private void GlobalSetupForRbacModelWithScale(int groupCount, int userCount, bool withRandomGroups = false)
        {
            ...
            NowRoleManager = (DefaultRoleManager)NowEnforcer.Model.Sections.GetRoleAssertion(PermConstants.Section.RoleSection, PermConstants.DefaultRoleType).RoleManager;
        }
